...
export default function FavoritesSection() {
    ...
    return (
        <section id="favorites" className="relative py-32 bg-gradient-to-b from-space-dark to-black/50">
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-xl text-white/70 max-w-3xl mx-auto">
                        Your personal collection of cosmic wonders. Every favorite tells your unique story of exploration.
                    </p>
                </motion.div>
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <p className="text-white/60 mb-8">
                            Start building your cosmic collection by adding images from our gallery!
                        </p>
                        <button
                        ...
                        <AnimatePresence>
                            {favorites.map((favorite, index) => (
                                ...
                                >
                                    ...
                                    {/* Content */}
                                    <div>
                                        <h3 className="text-xl font-bold mb-2 line-clamp-2">{favorite.title}</h3>
