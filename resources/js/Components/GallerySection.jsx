...
export default function GallerySection({ apodData, loading }) {
    ...
    const handleFavorite = async (item) => {
        try {
            const response = await axios.post('/favorites', {
                ...
                metadata: JSON.stringify({ date: item.date, media_type: item.media_type })
            });
    ...
    return (
        <section id="gallery" className="relative py-32 bg-gradient-to-b from-space-dark to-black/50">
            <div className="container mx-auto px-6">
                {/* Section Header */}
                <motion.div
                ...
                >
                    ...
                    <p className="text-xl text-white/70 max-w-3xl mx-auto">
                        A curated collection of breathtaking images from across the universe,
                        captured by NASA's most advanced instruments.
                    </p>
                </motion.div>
                    ...
                    {apodData.map((item, index) => (
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    <FaHeart className={isFavorited(item.date) ? 'fill-current' : ''} />
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="overflow-y-auto max-h-[600px]">
                                    ...
                                    <p className="text-sm text-white/50 mb-6">{selectedImage.date}</p>
                                    <p className="text-white/80 leading-relaxed">{selectedImage.explanation}</p>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
