            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-white/70 max-w-3xl mx-auto">
                        Step onto the surface of Mars through the eyes of NASA's Curiosity Rover.
                        These aren't just photos—they're postcards from another world.
                    </p>
                </motion.div>
                    ...
                    {marsPhotos.slice(0, 12).map((photo, index) => (
                        ...
                        >
                            <div className="aspect-square overflow-hidden rounded-lg glass-card p-2">
                                ...
                                >
                                    <p className="text-white text-xs font-semibold">{photo.camera.full_name}</p>
                ...
                >
                    {[
                        { label: 'Distance from Earth', value: '225M km', color: 'from-red-500 to-orange-500' },
                        { label: 'Mission Duration', value: '11+ Years', color: 'from-orange-500 to-yellow-500' },
                        { label: 'Photos Captured', value: '700K+', color: 'from-yellow-500 to-red-500' },
                    ].map((stat, index) => (
                        <motion.div
                            key={index}
